Module modQryCliVenZon
    Public qry4dFacPriPar As String = "SELECT CODIGO_FACTURA AS ID_FACTURA,NUMERO_FACTURA,SerieDocumento AS SERIE,Prefijo_Documento AS PREFIJO, " +
    ...
    " AND EMPRESA = 'CIMSA' " +
    " AND FECHA_FACTURA BETWEEN '" & modClientes.dateFacIni & "' AND '" & modClientes.dateFacFin & "' " +
    " ORDER BY FECHA_FACTURA "

    Public qry4dFacDetPar As String = "SELECT   INV.DOC_ID_CORP2 AS ID_FACTURA, INV.`ORIGIN MEMO` AS ORIGEN,INV.Posicion AS LINEA, " +
    ...
    " AND CLN.FECHA_FACTURA BETWEEN '" & modClientes.dateFacIni & "' AND '" & modClientes.dateFacFin & "' "
End Module
