...
Public Class CrepPresDepto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CRUDColorimx.CrepPresDepto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrepPresDepto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrepPresDepto = New CrepPresDepto()
        rpt.Site = Me.Site
        Return rpt
    End Function
