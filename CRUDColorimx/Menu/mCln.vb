...
Module mCln
    ...
    Sub conf()
        ...
        Dim conexion As New SqlConnection("Data Source=" & sqlserver +
                                         ...
                                         "; Password=" & sqlpass +
                                         ";")
        Dim menus As New SqlCommand("SELECT USUARIOS.ID, USUARIOS.NOMBRE, USUARIOS.APELLIDO_P, USUARIOS.APELLIDO_M, USUARIOS.USUARIO, USUARIOS.ACCESO, M_CLIENTES.CLNT_1, " +
"M_CLIENTES.CLNT_2, M_CLIENTES.CLNT_3, M_CLIENTES.CLNT_4, M_CLIENTES.CLNT_5, M_CLIENTES.CLNT_6, M_CLIENTES.CLNT_7, " +
"M_CLIENTES.CLNT_8, M_CLIENTES.CLNT_9 FROM USUARIOS INNER JOIN M_CLIENTES ON USUARIOS.ID = M_CLIENTES.ID " +
