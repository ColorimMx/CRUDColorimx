...
Module mInv
    ...
    Sub conf()
        ...
        Dim conexion As New SqlConnection("Data Source=" & sqlserver +
                                         ...
                                         "; Password=" & sqlpass +
                                         ";")
        Dim menus As New SqlCommand("SELECT USUARIOS.ID, USUARIOS.NOMBRE, USUARIOS.APELLIDO_P, USUARIOS.APELLIDO_M, USUARIOS.USUARIO, USUARIOS.ACCESO, M_INVENTARIO.INVT_1, " +
"M_INVENTARIO.INVT_2, M_INVENTARIO.INVT_3, M_INVENTARIO.INVT_4, M_INVENTARIO.INVT_5, M_INVENTARIO.INVT_6, M_INVENTARIO.INVT_7, " +
"M_INVENTARIO.INVT_8, M_INVENTARIO.INVT_9 FROM USUARIOS INNER JOIN M_INVENTARIO ON USUARIOS.ID = M_INVENTARIO.ID " +
